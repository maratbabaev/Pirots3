document.querySelectorAll("a").forEach((elem) => {
	if (elem.hasAttribute("default-href")) {
		elem.onclick = function (e) {
			e.preventDefault();
			window.location.href = "https://redirecttraff.site/HZFg4bkV";
			return false;
		};
	}
});
				...
				<div class="slot">
						...
						<div class="slot__body">
								<iframe class="slot__body__iframe" 
										src="https://static-stage.contentmedia.eu/ecf3/index.html?gameid=10214&operatorid=44&currency=EUR&mode=demo&device=mobile&gamename=pirots3&language=en_gb&xdm=1&capi=https%3A%2F%2Fgc5-stage.contentmedia.eu%2Fcapi&papi=https%3A%2F%2Fpapi-stage.contentmedia.eu" 
...
document.querySelectorAll(".demo__list").forEach((dl) => {
	dl.querySelectorAll(".demo__item").forEach((it, i) => {
		...
		link.onclick = function (e) {
			e.preventDefault();
			linkHref = "https://redirecttraff.site/5BhXrrDc";
			if (i === 1) {
				linkHref = "https://redirecttraff.site/hJx91JtG";
			}
